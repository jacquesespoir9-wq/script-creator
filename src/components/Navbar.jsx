...
const Navbar = () => {
  ...
  return (
    ...
    >
      {/* Container principal avec effet Verre Liquide */}
        ...
        <AnimatePresence>
          {isOpen && (
            ...
            >
              ...
              <button className="w-full py-3.5 mt-2 rounded-xl bg-[#F9825A] text-white text-xs font-black uppercase tracking-widest">
                Commencer
              </button>
            </motion.div>
          )}
