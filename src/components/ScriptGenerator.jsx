...
Sois précis, concis et adapte le script au format ${platformInfo.label} (durée ${duration}s). Le script doit être directement utilisable pour filmer.`;
    ...
    try {
      // Note: In a real app, API calling happens on backend. 
      // For this demo, we keep the original logic.
  ...
  return (
    <div style={{ maxWidth: 900, margin: "0 auto", padding: "32px 24px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24 }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
        ...
        {/* Platform selection is hidden or read-only if we are on a specific page, or shown to allow switching? 
           The user wants "each mode on its page", implying we stay on that mode.
        */}
        <div>
